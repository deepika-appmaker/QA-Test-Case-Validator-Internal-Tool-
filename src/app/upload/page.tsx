                                ...
                                {guidelinesOpen && (
                                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-sm animate-in fade-in slide-in-from-top-2 duration-300">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <ul className="space-y-2 pl-8 text-stone-600 list-disc marker:text-stone-300">
                                                <li>Column names are flexible — click headers to rename mismatches</li>
                                                <li>Max 500 rows per file</li>
                                                <li>File size limit: 5MB</li>
                                                <li>Module column is optional (used for grouping)</li>
                                            </ul>
                                        </div>
                                    </div>
                                )}
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-stone-200 overflow-hidden">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        ...
                                        <p className="text-stone-500 text-sm">
                                            {parseResult.rows.length} rows · {parseResult.errors.length} errors
                                        </p>
                                    </div>
                            ...
                            <div className="p-6 md:p-8 pt-4">
                                {parseResult.errors.length > 0 ? (
                                    ...
                                    <CSVPreviewTable result={parseResult} onRenameHeader={handleRenameHeader} />
                                )}
                            </div>
                        </div>
                    </div>
